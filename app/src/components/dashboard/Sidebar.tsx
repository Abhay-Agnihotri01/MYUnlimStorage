...
import { Folder, HardDrive, LogOut, Plus, RefreshCw, Settings, Trash2, X, Image, Calendar } from 'lucide-react';
...
export function Sidebar({
    ...
    isSyncing, isConnected, onSync, onLogout, onOpenSettings, bandwidth, connectionLabel, savedMessagesOnly = false,
    ...
    const submitCreate = async () => {
        ...
        try {
            await onCreate(newFolderName, null);
            setNewFolderName("");
        ...
        >
            ...
            <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto min-h-0">
                ...
                <SidebarItem
                    icon={Image}
                    label="Collections"
                    active={activeDriveView === 'collections'}
                    onClick={() => {
                        onDriveViewChange?.('collections');
                        onMobileClose?.();
                    }}
                    onDrop={() => undefined}
                    folderId={null}
                ...
                <SidebarItem
                    icon={Calendar}
                    label="Timeline"
                    active={activeDriveView === 'timeline'}
                    onClick={() => {
                        onDriveViewChange?.('timeline');
                        onMobileClose?.();
                    }}
                    onDrop={() => undefined}
                    folderId={null}
            ...
            <div className="border-t border-telegram-border px-2 py-2 flex flex-col gap-1">
                <SidebarItem
                    icon={Trash2}
                    label="Trash"
